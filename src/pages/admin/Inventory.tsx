...
import {
  AlertTriangle, Boxes, Info, Search, X, ChevronLeft, ChevronRight, Cpu, RefreshCw
} from 'lucide-react';
  ...
  return (
    <AdminLayout title="Warehouse Inventory Overview">
      <div className="space-y-6">
        ...
        <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-800 dark:text-emerald-300 flex items-start justify-between gap-3 text-xs leading-relaxed font-medium">
          ...
          <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20 flex items-center gap-1 shrink-0">
