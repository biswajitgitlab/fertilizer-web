...
import { PackageCheck, Plus, RefreshCw, Layers, Calendar, Warehouse, Save, X } from 'lucide-react';
            ...
            <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border border-slate-200/80 dark:border-slate-800/80 rounded-3xl p-6 sm:p-8 max-w-lg w-full shadow-2xl space-y-6">
              ...
              <form onSubmit={handleCreate} className="space-y-4 text-xs">
                ...
                <SearchableSelect
                  ...
                  onChange={(val) => setFormData({ ...formData, product_id: String(val) })}
                ...
                {/* Searchable Warehouse Zone Select */}
                <SearchableSelect
                  label="Warehouse Storage Zone"
                  required
                  options={zones.map(z => ({
                    value: z.code,
                    label: `${z.code} - ${z.name}`,
                  ...
                  onChange={(val) => setFormData({ ...formData, warehouse_zone: String(val) })}
