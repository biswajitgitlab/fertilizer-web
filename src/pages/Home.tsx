        ...
        <div className="max-w-7xl mx-auto space-y-8">
          <div className="text-center space-y-2 max-w-2xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 font-medium">
              Next-generation technology, NABL lab-tested inputs, precision drone spraying, and automated crop calendars tailored for high-output farming.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            
            {/* Bento Card 1: AI Clinic with Leaf Scanner Visual */}
            <div className="md:col-span-2 rounded-3xl p-6 sm:p-8 bg-white/90 dark:bg-gradient-to-br dark:from-emerald-950/80 dark:to-slate-950/90 border border-emerald-300/80 dark:border-emerald-500/30 backdrop-blur-xl relative overflow-hidden flex flex-col justify-between group hover:border-emerald-400 transition-all duration-300 shadow-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center relative z-10">
                <div className="lg:col-span-7 space-y-4">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
                    Scan affected plant leaves with your smartphone camera. Our trained AI model detects 150+ fungal, bacterial, and pest infestations with 98%+ precision and provides instant spray formulas.
                  </p>
            ...
            <div className="rounded-3xl p-6 sm:p-7 bg-white/90 dark:bg-slate-950/80 border border-teal-200/80 dark:border-teal-500/30 backdrop-blur-xl flex flex-col justify-between space-y-5 group hover:border-teal-400 transition-all duration-300 shadow-xl">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <span className="text-[10px] font-black uppercase text-teal-700 dark:text-teal-400 tracking-wider">Precision Testing</span>
                  <h3 className="text-xl font-black text-slate-900 dark:text-white">Soil &amp; Water Lab Testing</h3>
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                    Send soil samples to get 14-parameter NPK, pH, EC, and micronutrient reports. Receive digital recommendation charts in 48 hours.
                  </p>
                </div>
              </div>

              <div className="pt-2 border-t border-slate-200/80 dark:border-white/10">
                <span className="text-teal-700 dark:text-teal-400 text-xs font-bold flex items-center gap-1.5">
                  <Zap className="w-4 h-4" /> 48-Hour Digital Lab Report
                </span>
              </div>
            </div>
            ...
            <div className="rounded-3xl p-6 sm:p-7 bg-white/90 dark:bg-slate-950/80 border border-amber-200/80 dark:border-amber-500/30 backdrop-blur-xl flex flex-col justify-between space-y-5 group hover:border-amber-400 transition-all duration-300 shadow-xl">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <span className="text-[10px] font-black uppercase text-amber-700 dark:text-amber-400 tracking-wider">Heavy Load Logistics</span>
                  <h3 className="text-xl font-black text-slate-900 dark:text-white">Custom NPK &amp; Doorstep Delivery</h3>
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                    Order custom NPK formulations and 50kg moisture-proof bag orders delivered directly to your farm gate across Punjab, Haryana, UP &amp; MP.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-3xl p-6 sm:p-7 bg-white/90 dark:bg-slate-950/80 border border-sky-200/80 dark:border-sky-500/30 backdrop-blur-xl flex flex-col justify-between space-y-5 group hover:border-sky-400 transition-all duration-300 shadow-xl">
              <div className="space-y-4">
                <div className="relative rounded-2xl overflow-hidden border border-sky-500/30 aspect-16/9 group-hover:scale-[1.02] transition-transform duration-500">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/30 to-transparent" />
                  <div className="absolute top-2.5 left-2.5 bg-slate-950/85 backdrop-blur-md border border-sky-400/40 text-sky-300 text-[10px] font-black px-2.5 py-1 rounded-lg">
                    10 Acres / 15 Mins
                  </div>
                </div>

                <div className="space-y-2">
                  <div className="w-10 h-10 bg-sky-500/20 border border-sky-400/30 rounded-xl flex items-center justify-center text-sky-600 dark:text-sky-400 font-bold">
                    <Sparkles className="w-5 h-5 text-sky-600 dark:text-sky-400" />
                  </div>
                  <span className="text-[10px] font-black uppercase text-sky-700 dark:text-sky-400 tracking-wider">Drone Fleet Booking</span>
                  <h3 className="text-xl font-black text-slate-900 dark:text-white">Precision Drone Spray Service</h3>
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                    Book certified agricultural spray drones for liquid fertilizers and crop protection sprays. Save 90% water and achieve 100% uniform canopy coverage.
                  </p>
                </div>
              </div>

              <div className="pt-2 border-t border-slate-200/80 dark:border-white/10">
                <span className="text-sky-700 dark:text-sky-400 text-xs font-bold flex items-center gap-1.5">
                  <Zap className="w-4 h-4" /> 90% Water &amp; Labor Savings
                </span>
              </div>
            </div>

            {/* Bento Card 5: Smart Crop Calendar Planner */}
            <div className="md:col-span-2 rounded-3xl p-6 sm:p-8 bg-white/90 dark:bg-gradient-to-br dark:from-teal-950/80 dark:to-slate-950/90 border border-teal-300/80 dark:border-teal-500/30 backdrop-blur-xl relative overflow-hidden flex flex-col justify-between group hover:border-teal-400 transition-all duration-300 shadow-xl">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center relative z-10">
                <div className="lg:col-span-7 space-y-4">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
                    Input your crop sowing date for Paddy, Wheat, Cotton, Sugarcane, or Vegetables. Receive automated SMS and mobile alerts for basal dosage, tillering top-dressing, and micronutrient sprays.
                  </p>
                ...
                <div className="lg:col-span-5 relative">
                  <div className="relative rounded-2xl overflow-hidden border border-teal-400/40 shadow-2xl group-hover:scale-[1.02] transition-transform duration-500 aspect-4/3 sm:aspect-16/10 lg:aspect-square">
                    ...
                    <div className="absolute top-3 left-3 bg-slate-950/85 backdrop-blur-md border border-teal-400/40 px-2.5 py-1 rounded-lg flex items-center gap-1.5 text-[10px] text-teal-300 font-bold shadow-lg">
                      ...
                      <span>Active Growth Stage 2</span>
                    </div>
                    ...
                    <div className="absolute bottom-3 left-3 right-3 p-2.5 rounded-xl bg-slate-950/80 backdrop-blur-md border border-white/20 text-white space-y-0.5">
                      ...
                      <p className="text-xs font-bold text-slate-100 line-clamp-1">Spray Zinc EDTA 12% + NPK 19:19:19</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-3xl p-6 sm:p-7 bg-white/90 dark:bg-slate-950/80 border border-indigo-200/80 dark:border-indigo-500/30 backdrop-blur-xl flex flex-col justify-between space-y-5 group hover:border-indigo-400 transition-all duration-300 shadow-xl">
              <div className="space-y-4">
                <div className="relative rounded-2xl overflow-hidden border border-indigo-500/30 aspect-16/9 group-hover:scale-[1.02] transition-transform duration-500">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/30 to-transparent" />
                  <div className="absolute top-2.5 left-2.5 bg-slate-950/85 backdrop-blur-md border border-indigo-400/40 text-indigo-300 text-[10px] font-black px-2.5 py-1 rounded-lg">
                    ICAR Certified
                  </div>
                </div>

                <div className="space-y-2">
                  <div className="w-10 h-10 bg-indigo-500/20 border border-indigo-400/30 rounded-xl flex items-center justify-center text-indigo-600 dark:text-indigo-400 font-bold">
                    <User className="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
                  </div>
                  <span className="text-[10px] font-black uppercase text-indigo-700 dark:text-indigo-400 tracking-wider">Expert Hotline</span>
                  <h3 className="text-xl font-black text-slate-900 dark:text-white">1-on-1 Agronomist Consultation</h3>
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                    Speak directly with certified agricultural scientists via voice or video call for tailored advice on crop rot, pest outbreaks, and high-yield seed selection.
                  </p>
                </div>
              </div>

              <div className="pt-2 border-t border-slate-200/80 dark:border-white/10">
                <span className="text-indigo-700 dark:text-indigo-400 text-xs font-bold flex items-center gap-1.5">
                  <CheckCircle className="w-4 h-4" /> Direct Doctor Support
                </span>
              </div>
            </div>
