...
export const RecentlyViewedSection: React.FC<{ currentProductId?: string | number }> = ({ currentProductId }) => {
  ...
  return (
    <section className="py-8 space-y-4">
      <div className="relative rounded-3xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-emerald-200/60 dark:border-slate-800 p-6 sm:p-8 shadow-xl shadow-emerald-900/5 transition-all duration-300">
