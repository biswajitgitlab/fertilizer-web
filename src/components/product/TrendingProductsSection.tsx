...
export const TrendingProductsSection: React.FC = () => {
  ...
  return (
    <section className="py-6 sm:py-8 space-y-4">
      <div className="relative rounded-2xl sm:rounded-3xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-amber-200/60 dark:border-slate-800 p-4 sm:p-7 shadow-xl shadow-amber-900/5 transition-all duration-300">
